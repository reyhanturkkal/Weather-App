...
import com.example.weatherapp.ViewModel.WeatherViewMdl
...
class MainActivity : AppCompatActivity() {
    ...
    private val weatherViewModel:WeatherViewMdl by viewModels()
                ...
                override fun onResponse(
                    ...
                    if(response.isSuccessful){
                        ...
                        data?.let{
                            ...
                            humidtyTxt.text=it.main?.humidity?.toString()+"%"
